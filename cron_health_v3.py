#!/usr/bin/env python3
"""Single-file health check cron job — Wednesday 2026-09-20 run."""
...
# save history (append only — never delete previous entries)
entry = {
...
try:
    ...
    if resp.status_code == 400:
        print(f"NOTE: row not inserted due to schema mismatch, kept in local history.")
except Exception as e:
