...
print("Looking for:", raw_path, "file exists:", __import__('os').path.exists(raw_path))
...
try:
    r2 = subprocess.run(["bash", "-c", "free -m"], capture_output=True, text=True, timeout=5)
    if r2.returncode == 0 and "Mem:" in r2.stdout:
        for line in r2.stdout.split("\n"):
            if line.startswith("Mem:"):
                ...
                print("RAM via bash free -m: avail={}MB total={}MB status={}".format(avail_mb, total_mb, ram_status))
                break
        else:
            print("No Mem: line in free -m output")
    else:
        print("free -m via bash failed: rc={} stderr={}".format(r2.returncode, r2.stderr[:200]))
...
# Save to file
with open("C:/Users/hello/AppData/Local/Temp/report_final.json", "w") as f:
    json.dump(r, f, indent=2, ensure_ascii=False)
print("Saved to C:/Users/hello/AppData/Local/Temp/report_final.json")
